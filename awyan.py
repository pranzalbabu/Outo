...
folder_path = '/sdcard/AUTO_CREATE_AWYAN.txt'
try:
...
def p(x):
    print(x)
#------------------------[ VERSION ]-----------------------#
____Version____ = '\033[1;32mV/ERROR'
#------------------[ LOGO ]-------------------#
logo=(f"""\033[1;32m
        

   
      __          ____     __                _   _   _  ___    _          _   _ 
     /\ \        / /\ \   / //\        /\   | \ | | | |/ / |  | |   /\   | \ | |
    /  \ \  /\  / /  \ \_/ //  \      /  \  |  \| | | ' /| |__| |  /  \  |  \| |
   / /\ \ \/  \/ /    \   // /\ \    / /\ \ | . ` | |  < |  __  | / /\ \ | . ` |
  / ____ \  /\  /      | |/ ____ \  / ____ \| |\  | | . \| |  | |/ ____ \| |\  |
...
\033[1;34m────────────────────────────────────────────────────────
 \033[1;32m[\033[1;31m–\033[1;32m] AUTHOR   :  AWYAN KHAN
 \033[1;32m[\033[1;31m–\033[1;32m] SERVICE  : {rrrrrrrr}FREE ENJOY\033[;0m┼{____Version____}
 \033[1;32m[\033[1;31m–\033[1;32m] TOOLS    : AUTO CREATE FACEBOOK
\033[1;34m────────────────────────────────────────────────────────
 NOTE METHOD 1 WORKING HAI
\033[1;34m────────────────────────────────────────────────────────""") 
#------------------[ LINEX ]-------------------#
def linex():
    print(f'\033[1;34m────────────────────────────────────────────────────────')
...
def auto_create_fb_method_1_() -> None:
    ...
    for make in range(50000):
        ...
        sys.stdout.write(f'\r\r\033[1;37m<[{boos}JUTT-BRAND\033[1;37m]<×>[{make+1}|\033[1;32m{oks}\033[1;37m]> ');sys.stdout.flush()
        ...
        if "c_user" in py_submit.cookies:
            ...
            print('\r\033[1;32m<[AWYAAN-KHAN-OK]> ' + uid + ' | ' + pasw2 + '\033[1;37m')
            ...
            #linex()
            file_path_ok = os.path.join(folder_path, 'AWYAAN-KHAN-OK.txt')
            file_path_cookies = os.path.join(folder_path, 'AWYAAN-CREATE-COOKIE.txt')
...
def auto_create_fb_method_2_() -> None:
    ...
    for make in range(1000):
        sys.stdout.write(f'\r\r\033[1;37m<[{boos}JUTT\033[1;37m]<×>[{make+1}|\033[1;32m{len(ok)}\033[1;37m]> ');sys.stdout.flush()
        ses = requests.Session()
        fake = Faker()
        ...
        if ethan_username in ['3','03']:
           firstname,lastname = fake_vietnamese()
        domain = random.choice(['gmail.com','yopmail.com','hotmail.com','yahoo.com',])
        email2 = f"{firstname.lower()}{lastname.lower()}{random.randint(10,99)}@{domain}"
        if ethan_password in ['1','01']:
            pasw2 = f"{firstname.lower()}{lastname.lower()}"
        time.sleep(5)
